<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateDetails.aspx.cs" Inherits="GCSEMatrix.UpdateDetails" %>
		...
		<div class="container">
			...
			<div class="row">
				<div class="form-inline">
					...
					<asp:TextBox ID="txtStudentID" class="form-control" runat="server" Text='<%# Eval("PERSON_CODE") %>'  Enabled="False"></asp:TextBox>
				</div>
				<div class="form-inline">
					<label for="txtStudentName" class="lead">Student Name:</label>
					<asp:TextBox ID="txtStudentName" class="form-control" Enabled="False" Text='<%# Eval("STUDENT_NAME") %>' runat="server"></asp:TextBox>
				</div>
				...
				<div class="form-inline">
					...
					<asp:TextBox ID="txtUCI" required class="form-control" runat="server" Text='<%# Eval("UCI_NUMBER") %>' placeholder="E.G 577211217376N" MaxLength="13"></asp:TextBox>
				</div>
			   <div class="table-responsive col-lg-6">
			   <p class="lead">GCSEs</p>
				<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetGCSELearnerResults" TypeName="GCSEMatrix.DAO.ReturnData">
					<SelectParameters>
						<asp:ControlParameter ControlID="txtStudentID" DefaultValue="" Name="person_code" PropertyName="Text" Type="Int32" />
					</SelectParameters>
				...
				<table style="width:auto;" class="table table-bordered table-inverse">
					...
					<ItemTemplate>
						...
						<asp:Label ID="lblRecordExists" runat="server" CssClass="sr-only" Text='<%# Eval("RECORD_EXISTS") %>'></asp:Label>
						</tbody>
					</ItemTemplate>
			   <FooterTemplate>
					</table>
				...
				<div class="table-responsive col-lg-6">
					<table class="table table-bordered table-inverse">
						...
						<tbody>
							<tr>									<asp:Label ID="DDLVocationalSubjectExists1" runat="server" Text='<%# Eval("RECORD_EXISTS") %>'></asp:Label>
					...
					<asp:Button ID="BtnViewReport" cssClass="btn btn-default" runat="server" Visible="false" Text="Print Results" OnClick="BtnViewReport_Click" />
