		...
		<div class="container">
		   <asp:Label ID="lblUser" runat="server" >
			...
			<div class="row">
				...
				<div class="form-inline">
					<label for="txtStudentName" id="lblStudentName" class="lead">Student Name:</label>
			...
			<FooterTemplate>
				...
				<div class="table-responsive col-lg-6">
					...
					<asp:Button ID="BtnUpdateResults" cssClass="btn btn-default" runat="server" Visible="False" Text="Update Results" runat="server" OnClick="BtnUpdateResults_Click" />
